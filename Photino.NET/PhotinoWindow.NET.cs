...
public partial class PhotinoWindow
{
    ...
    public async Task<string?> ShowSaveFileAsync(string title = "Save file", string? defaultPath = null, (string Name, string[] Extensions)[]? filters = null, string? defaultFileName = null)
    {
