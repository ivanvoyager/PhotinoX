...
internal static class NativeDelegates
{
    ...
    [UnmanagedFunctionPointer(CC)] public delegate void StateChangedCallback([MarshalAs(UnmanagedType.I4)] PhotinoWindowState oldState, [MarshalAs(UnmanagedType.I4)] PhotinoWindowState newState);
